...
module.exports = {
  ...
  /**
   * Changes the user name for all respective entries in the database.
   * @param  {string} formerName The former username.
   * @param  {string} newName    The new username.
   */
  changeUserName: function(formerName, newName) {
    history.forEach(function changeUserNameInHistory(entry) {
      if (entry.name === formerName) {
        entry.name = newName;
      }
    });
  }
