...
module.exports = {
  ...
  /**
   * Generates a command for changing another user's name.
   * @param  {string} formerName The former name of the user.
   * @param  {string} newName    The new name of the user.
   * @return {object} command    The generated otherUserNameChange command.
   */
  generateUserNameChange: function(formerName, newName) {
    return makeCommand('userNameChange', ['former', formerName], ['new', newName]);
  },

  /**
   * Generates a command if the desired username is already taken.
   */
  generateNameAlreadyTaken: function() {
    return makeCommand('nameAlreadyTaken');
  }
};
